...
loom {
    forge {
        ...
        mixinConfig(
            "abitmorehex-common.mixins.json",
            "abitmorehex-forge.mixins.json",
        )
    }
    ...
    runs {
        register("commonDatagen") {
            ...
            property("abitmorehex.apply-datagen-mixin", "true")
        }
    }
}

abitmorehexModDependencies {
