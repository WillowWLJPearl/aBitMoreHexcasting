...
abstract class AbitmorehexModDependenciesExtension(private val project: Project) {
...
val extension = extensions.create<AbitmorehexModDependenciesExtension>("abitmorehexModDependencies")
