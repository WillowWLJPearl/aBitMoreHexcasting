...
object OpEvokeGraspingVines : SpellAction {
    override val argc = 3
    ...
    override fun execute(args: List<Iota>, env: CastingEnvironment): SpellAction.Result {
        ...
        val cost: Long = ((duration.toDouble()* 0.2 * amplifier).pow(2)).toLong()
    ...
    private data class Spell(val entity: net.minecraft.world.entity.Entity, val duration: Int, val amplifier: Int) : RenderedSpell {
        override fun cast(env: CastingEnvironment) {
            if (entity is LivingEntity) {
                ...
                val instance = MobEffectInstance(AbitmorehexEffects.GRASPING_VINES.value, duration*20, amplifier)
