...
import hexdoc_abitmorehex

from .__gradle_version__ import FULL_VERSION, GRADLE_VERSION
from .__version__ import PY_VERSION


class AbitmorehexPlugin(ModPluginImpl):
    @staticmethod
    @hookimpl
    def hexdoc_mod_plugin(branch: str) -> ModPlugin:
        return AbitmorehexModPlugin(branch=branch)


class AbitmorehexModPlugin(ModPluginWithBook):
    @property
    @override
    def modid(self) -> str:
        return "abitmorehex"
    ...
    def jinja_template_root(self) -> tuple[Package, str]:
        return hexdoc_abitmorehex, "_templates"
